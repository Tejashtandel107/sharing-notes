...
export interface ApiNoteNote extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    download_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::download-history.download-history'
    >;
    downloaded: Schema.Attribute.BigInteger;
    externalLink: Schema.Attribute.String;
    file: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    isPastPaper: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::note.note'> &
      Schema.Attribute.Private;
    materialType: Schema.Attribute.Enumeration<
      ['Pdf', 'Document', 'Image', 'Video', 'Link', 'Other']
    > &
      Schema.Attribute.Required;
    paperYear: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    saved_notes: Schema.Attribute.Relation<'oneToMany', 'api::note.note'>;
